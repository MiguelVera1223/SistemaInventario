...
class CategoriaModel(models.Model):
    ...
    categoriaDescripcion= models.CharField(
        max_length=45, 
        db_column='categoria_descripcion')
    class Meta:
...
class ProductoModel(models.Model):
    ...
    productoCodigo= models.CharField(max_length=45, db_column='producto_codigo')
    ...
    productoEstado = models.CharField(max_length=45, db_column='producto_estado')
...
class MovimientoModel(models.Model):
    ...
    personaId = models.ForeignKey(
        PersonaModel, 
        on_delete=models.PROTECT, 
        db_column='persona_id', 
        related_name='PersonaMovimiento')
    usuarioId = models.ForeignKey(
        UsuarioModel, 
        on_delete=models.PROTECT,
        db_column='usuario_id', 
        related_name='UsuarioMovimiento')
    class Meta:
